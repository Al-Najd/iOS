...
public enum Asset {
    public enum Background {
        public static let headerBig = ImageAsset(name: "header-big")
        public static let headerMini = ImageAsset(name: "header-mini")
    }
    ...
    public enum Prayers {
        ...
        public enum Nafila {
            ...
            public static let qeyamImage = ImageAsset(name: "qeyamImage")
            public static let subhImage = ImageAsset(name: "subhImage")
        }
    }
}
