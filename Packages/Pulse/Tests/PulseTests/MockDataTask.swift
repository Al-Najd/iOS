...
private let mockLoginResponse = HTTPURLResponse(
...
private let mockProfileFailureResponse = HTTPURLResponse(
    url: URL(string: "https://github.com/profile/valdo")!,
    statusCode: 404,
    httpVersion: "2.0",
    headerFields: [
        "Content-Length": "18",
...
private let mockOctocatResponse = HTTPURLResponse(
    url: URL(string: "https://github.com/octocat.png")!,
    statusCode: 302,
    httpVersion: "2.0",
    headerFields: [
