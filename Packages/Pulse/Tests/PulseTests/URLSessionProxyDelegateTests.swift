...
// MARK: - URLSessionProxyDelegateTests

final class URLSessionProxyDelegateTests: BaseTestCase {
    ...
    func testForwardingOfUnimplementedMethod() throws {
        ...
        let didBecomeInvalid = expectation(description: "didBecomeInvalid")
...
// MARK: - MockSessionCustomMethodImplemented
