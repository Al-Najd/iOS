...
// MARK: - NetworkRequestStatusCellModel
...
struct NetworkRequestStatusCellModel {
    ...
    init(task: NetworkTaskEntity) {
        title = ConsoleFormatter.status(for: task)
        imageName = task.state.iconSystemName
        tintColor = task.state.tintColor
