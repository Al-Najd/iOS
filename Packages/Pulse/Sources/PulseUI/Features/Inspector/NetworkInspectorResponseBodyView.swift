...
// MARK: - NetworkInspectorResponseBodyView
    ...
    var contents: some View {
        if let viewModel = viewModel.fileViewModel {
            ...
            PlaceholderView(
                ...
                title: "Unavailable",
                subtitle: "The response body was deleted from the store to reduce its size")
        } else {
...
// MARK: - NetworkInspectorResponseBodyViewModel
