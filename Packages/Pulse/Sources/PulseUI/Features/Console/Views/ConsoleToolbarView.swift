...
struct ConsoleModePicker: View {
    ...
    init(environment: ConsoleEnvironment) {
        ...
        logsCounter = environment.logCountObserver
        tasksCounter = environment.taskCountObserver
    }
    ...
    var body: some View {
        HStack(spacing: spacing) {
            ...
            ConsoleModeButton(
                title: "Logs",
                details: CountFormatter.string(from: logsCounter.count),
                isSelected: environment.mode == .logs) {
                    environment.mode = .logs
                }
            ConsoleModeButton(
                title: "Network",
                details: CountFormatter.string(from: tasksCounter.count),
                isSelected: environment.mode == .network) {
