...
// MARK: - NetworkInspectorMetricsView
...
// MARK: - NetworkInspectorMetricsViewModel
...
struct NetworkInspectorMetricsView_Previews: PreviewProvider {
    static var previews: some View {
        ...
        NetworkInspectorMetricsView(viewModel: .init(
            task: LoggerStore.preview.entity(for: .createAPI))!).previewLayout(.fixed(width: 500, height: 800))
        #else
        NavigationView {
            NetworkInspectorMetricsView(viewModel: .init(
