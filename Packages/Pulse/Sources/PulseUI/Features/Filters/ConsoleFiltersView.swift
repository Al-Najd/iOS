    ...
    var sessionsSection: some View {
        ConsoleSection(isDividerHidden: true, header: {
            ConsoleSectionHeader(
                icon: "list.clipboard",
                title: "Sessions",
                filter: $viewModel.criteria.shared.sessions,
                default: viewModel.defaultCriteria.shared.sessions)
        }, content: {
    ...
    var networkingSection: some View {
        ConsoleSection(header: {
            ConsoleSectionHeader(
                ...
                title: "Networking",
                filter: $viewModel.criteria.network.networking)
        }, content: {
