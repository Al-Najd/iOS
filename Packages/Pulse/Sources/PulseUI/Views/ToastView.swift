...
final class ToastManager {
    ...
    func showToastIfNeeded() {
        ...
        toast.view.center = CGPoint(
            x: container.view.bounds.width / 2,
            y: container.view.bounds.height - toast.view.bounds.height - container.view.safeAreaInsets.bottom)
