...
extension MockTask {
    ...
    static let profile = MockTask(
        ...
        transactions: [
            .init(
                ...
                request: mockProfileCurrentRequest,
                response: mockProfileFailureResponse,
                duration: 0.22691)
        ],
        delay: 2.0)
    ...
    static let octocat = MockTask(
        ...
        transactions: [
            ...
            .init(
                fetchType: .networkLoad,
                request: mockOctocatCurrentRequest,
                response: mockOctocatNotModifiedResponse,
                duration: 0.2239)
        ],
        delay: 3.5)
    ...
    static let downloadNuke = MockTask(
        ...
        transactions: [
            .init(
                ...
                response: mockDownloadNukeRedirectResponse,
                duration: 0.21283),
            .init(
                fetchType: .networkLoad,
                request: mockDownloadNukeCurrentRequest,
                response: mockDownloadNukeResponse,
                duration: 4.25254,
    ...
    static let uploadPulseArchive = MockTask(
        ...
        transactions: [
            .init(
                fetchType: .networkLoad,
                request: mockUploadPulseCurrentRequest,
                response: mockUploadPulseResponse,
                duration: 2.21283,
                isReusedConnection: true),
        ],
    ...
    static let createAPI = MockTask(
        ...
        transactions: [
            .init(
                fetchType: .networkLoad,
                request: mockCreateAPICurrentRequest,
                response: mockCreateaAPIRedirectResponse,
                duration: 0.20283),
            .init(
                fetchType: .localCache,
                request: mockCreateAPIRedirectRequest,
                response: mockCreateaAPIResponse,
                duration: 0.003),
            .init(
                fetchType: .networkLoad,
                request: mockCreateAPIRedirectRequest,
                response: mockCreateAPIResponseNotChanged,
                duration: 0.0980,
                isReusedConnection: true),
        ],
        delay: 5.5)
    ...
    static let patchRepo = MockTask(
        ...
        transactions: [
            .init(
                fetchType: .networkLoad,
                request: mockPatchRepoCurrentRequest,
                response: mockPatchRepoResponse,
                duration: 1.32691)
        ],
        delay: 6.5,
...
private let mockDownloadNukeRedirectResponse = HTTPURLResponse(
    url: "https://codeload.github.com/kean/Nuke/zip/tags/11.0.0",
    statusCode: 302,
    headers: [
        "Server": "GitHub.com",
        "Content-Type": "text/html; charset=utf-8",
...
private let mockDownloadNukeResponse = HTTPURLResponse(
    url: "https://codeload.github.com/kean/Nuke/zip/tags/11.0.0",
    statusCode: 200,
    headers: [
...
private let mockUploadPulseResponse = HTTPURLResponse(
    url: "https://objects-origin.githubusercontent.com/github-production-release-asset-2e65be",
    statusCode: 204,
    headers: [
        "Vary": "Origin",
