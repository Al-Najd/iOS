...
public enum L10n {
    ...
    public static let toStartYourJourneyToYourHomeIn = L10n.tr(
        "Localizables",
        " to start your Journey to your Home in ",
        fallback: " لبدء رحلتك إلى منزلك في ")
    /// , و %@
    public static func andDay(_ p1: Any) -> String {
        L10n.tr("Localizables", ", and day", String(describing: p1), fallback: ", و %@")
    }
    ...
    public static let aDayFullOfBlessingsIsAwaitingYourDeeds = L10n.tr(
        "Localizables",
        "A day full of blessings is awaiting your deeds!",
        fallback: "يوما مليئ بالاعمال الطيبة في انتظارك!")
    /// كشخص صالح
    ...
    public static let alNajdTranslation = L10n.tr(
        "Localizables",
        "Al Najd Translation",
        fallback: "اي الطريقين (طريق الخير, وطريق الشر).")
    ...
    public static let allOfThisAndMoreInTheFutureInShaaAllahWillBeAvailableFromTheSettings = L10n.tr(
        "Localizables",
        "All of this and more (in the future In Shaa Allah) will be available from the Settings",
        fallback: "كل هذا وأكثر (في المستقبل إن شاء الله) سوف تكون متاحة من إعدادات")
    /// الله
    public static let allah = L10n.tr("Localizables", "Allah", fallback: "الله")
    /// كان حقا علي الله ان يرضيك .
    public static let allahMustSatisfyYou = L10n.tr(
        "Localizables",
        "Allah Must Satisfy you",
        fallback: "كان حقا علي الله ان يرضيك .")
    /// الله اكبر
    ...
    public static let andOurGreatestFeatureEverTillNow = L10n.tr(
        "Localizables",
        "And our greatest feature ever (till now)",
        fallback: "ولدينا أعظم ميزة من أي وقت مضى (حتى الآن)")
    /// وإعادة النظر في نفسك القديمة لمعرفة ما الترجيحات اللتي حصلت عليها ذلك اليوم
    public static let andRevisitYourOlderSelfToSeeWhatInsightDidYouGetThatDayOrYourWork = L10n.tr(
        "Localizables",
        "And revisit your older self to see what insight did you get that day or your work",
        fallback: "وإعادة النظر في نفسك القديمة لمعرفة ما الترجيحات اللتي حصلت عليها ذلك اليوم")
    /// وبما أنه في طبيعة البشرية أن تكون مادية
    public static let andSinceItSInTheNatureOfMankindToBeMateralistic = L10n.tr(
        "Localizables",
        "And since it's in the nature of mankind to be materalistic",
        fallback: "وبما أنه في طبيعة البشرية أن تكون مادية")
    /// و اسري بهدي الله و نفسك
    public static let andTakeYourselfWithAllahSSWTGuidance = L10n.tr(
        "Localizables",
        "And take yourself with Allah's (SWT) guidance ",
        fallback: "و اسري بهدي الله و نفسك ")
    /// وأنك
    ...
    public static let andThoseWhoMayComeAfter = L10n.tr(
        "Localizables",
        "And those who may come after",
        fallback: "وأولئك الذين قد يأتون بعد رحيلنا")
    /// و %@ بركات و معززات اخري
    public static func andVarOtherBlessingsAndBuffs(_ p1: Any) -> String {
        L10n.tr(
            "Localizables",
            "And var other blessings and Buffs...",
            String(describing: p1),
            fallback: "و %@ بركات و معززات اخري")
    }
    ...
    public static let azkarAreTheFortYourDefenseAndYourOffense = L10n.tr(
        "Localizables",
        "Azkar are the fort, your defense, and your offense",
        fallback: "الأذكار هي حصنك، دفاعك، وهجومك ")
    /// كن
    ...
    public static let butMakeYourJourneyFullOfBlessingsUnexpectedHappinessAndLotsOfPeace = L10n.tr(
        "Localizables",
        "But make your journey full of blessings, unexpected happiness and lots of peace",
        fallback: "ولكن جعل رحلتك كاملة من البركات والسعادة غير متوقعة والكثير من الراحة النفسية")
    /// لكن الآن أنت لست مرتاحة معها بعد الآن؟
    public static let butNowYouReNotComfortableWithItAnymore = L10n.tr(
        "Localizables",
        "but now you're not comfortable with it anymore?",
        fallback: "لكن الآن أنت لست مرتاحة معها بعد الآن؟")
    /// ولكن, هناك امر واقع لا يمكنك تجاهلها
    public static let butThereIsOneUnavoidableTruthThatYouLlNeverEscape = L10n.tr(
        "Localizables",
        "But there is one unavoidable truth that you'll never escape",
        fallback: "ولكن, هناك امر واقع لا يمكنك تجاهلها")
    /// بتعلمك اكثر عن
    public static let byLearningAboutTheBenefitsOf = L10n.tr(
        "Localizables",
        "By learning about the benefits of",
        fallback: "بتعلمك اكثر عن ")
    /// بالمناسبة نحن بحاجة إلى مساعدة في هذا، فإن كنت ترغب في مساعدتنا، يرجى ابلاغي
    public static let byTheWayWeNeedHelpWithThisSoIfWantToHelpPleaseReachMeOutThroughTheSettingsPage = L10n.tr(
        "Localizables",
        "By the way we need help with this, so if want to help, please reach me out through the settings page",
        fallback: "بالمناسبة نحن بحاجة إلى مساعدة في هذا، فإن كنت ترغب في مساعدتنا، يرجى ابلاغي")
    /// عدد السعرات الحرارية: %@
    public static func categoryCalories(_ p1: Any) -> String {
        L10n.tr("Localizables", "category_calories", String(describing: p1), fallback: "عدد السعرات الحرارية: %@")
    }

    /// وصف الفئة: %@
    public static func categoryDescription(_ p1: Any) -> String {
        L10n.tr("Localizables", "category_description", String(describing: p1), fallback: "وصف الفئة: %@")
    }

    /// اسم الفئة: %@
    public static func categoryName(_ p1: Any) -> String {
        L10n.tr("Localizables", "category_name", String(describing: p1), fallback: "اسم الفئة: %@")
    }
    ...
    public static func daysCount(_ p1: Int) -> String {
        L10n.tr("Localizables", "days_count", p1, fallback: "Plural format key: \"%#@daysCount@\"")
    }
    ...
    ///
    public static let donTLikeTheColorsFontIsTooSmallGotAPermissionYouGaveUsBefore = L10n.tr(
        "Localizables",
    ...
    public static func fieldCantBeEmpty(_ p1: Any) -> String {
        L10n.tr("Localizables", "field_cant_be_empty", String(describing: p1), fallback: "ال%@ لا يمكن ان يكون فارغا.")
    }
    ...
    public static let gotSomeDayYouDLikeToRevisit = L10n.tr(
        "Localizables",
        "Got some day you'd like to revisit?",
        fallback: "هل لديك يوم تود إعادة النظر فيه؟")
    ...
    public static let hintChoosingADateAllowsYouToRevisitYourAchievementsAtThatDate = L10n.tr(
        "Localizables",
        "Hint: Choosing a Date allows you to revisit your achievements at that date!",
        fallback: "لافتة: عندما تختار تاريخا, ستستطيع رؤية انجازاتك في هذا التاريخ!")
    /// خسارة, لكن ماذال معانا وقت, بينا نجتهد هذا الأسبوع!
    public static let hmmSadButWeStillHaveAChanceLetSPrayHardThisWeek = L10n.tr(
        "Localizables",
        "Hmm, sad, but we still have a chance! let's pray hard this week!",
        fallback: "خسارة, لكن ماذال معانا وقت, بينا نجتهد هذا الأسبوع!")
    /// ما رأيك, ان نتخذه تحدي لأنفسنا ان نملئ هذا الأسبوع بأعمال جميلة؟ ألن يكون هذا رائعا؟
    public static let howAboutWeMakeItAChallengeToUsToPopulateThisWithGreatDeedsWouldnTThatBeAwesome = L10n.tr(
        "Localizables",
    ...
    /// إن كانت سنة الفچر خيرا من الدنيا و ما فيها, فما بالك بفرضها؟
    public static let ifTheSunnahWasBetterThanAllOfThatIsGoodOnLifeWhatDoYouThinkTheFajrIs = L10n.tr(
        "Localizables",
        "If the Sunnah was better than all of that is good on life, what do you think the Fajr is?",
        fallback: "إن كانت سنة الفچر خيرا من الدنيا و ما فيها, فما بالك بفرضها؟")
    /// في ذكرى وفاة
    public static let inTheMemoryOfMyPassedAway = L10n.tr(
        "Localizables",
        "In the memory of my passed away",
        fallback: "في ذكرى وفاة")
    /// يتيح لك زيادة او إنقاص الكلام المكتوب لسهولة رؤيته
    public static let increasesOrDecreasesTheFontSizeForBetterReadingExperienceWithoutStrainingYourEyeVeryMuch = L10n.tr(
        "Localizables",
        "Increases or decreases the font size for better reading experience without straining your eye very much",
        fallback: "يتيح لك زيادة او إنقاص الكلام المكتوب لسهولة رؤيته")
    /// غير كافي
    public static let insufficient = L10n.tr("Localizables", "Insufficient", fallback: "غير كافي")
    /// الآن اصبح يصلي معه السنة و النافلة!
    public static let isNowCallingYouToPrayItAndSunnahAndNafila = L10n.tr(
        "Localizables",
        "Is now calling you to pray it and Sunnah and Nafila!",
        fallback: "الآن اصبح يصلي معه السنة و النافلة!")
    ...
    public static let joinASupportiveCommunityOfFellowMuslims = L10n.tr(
        "Localizables",
        "Join a supportive community of fellow Muslims!",
        fallback: "انضم إلي مجتمع من المسلمين المتكافلين")
    /// يمكنك القيام بها!
    ...
    public static let knowYourWeaponsAndThatYouWillLearnThemTrainOnThemAndHopefullyFromAllahYouWillMasterThem = L10n.tr(
        "Localizables",
        "Know your weapons, and that you will learn them, train on them, and hopefully from Allah, you will master them",
        fallback: "تعرف على أسلحتك، وأنك ستتعلمها، وتتدرب عليها، ونأمل من الله أن تتقنها")
    ...
    public static func lastNDays(_ p1: Any) -> String {
        L10n.tr("Localizables", "Last n Days", String(describing: p1), fallback: "اخر %@ ايام")
    }
    ...
    public static let likeEncourageYouPraiseYouGiveYouSomeWarningForMissingCriticalDeeds = L10n.tr(
        "Localizables",
        "Like encourage you, praise you, give you some warning for missing critical deeds",
        fallback: "كتشجيعك، والثناء عليك، تعطيك بعض التحذير لتفويت الأعمال الحرجة")
    /// لم تحصل علي اي هداية من %@ بعد
    public static func locked(_ p1: Any) -> String {
        L10n.tr("Localizables", "Locked", String(describing: p1), fallback: "لم تحصل علي اي هداية من %@ بعد")
    }
    ...
    public static let makeSalatEasyAndFun = L10n.tr(
        "Localizables",
        "Make Salat Easy and Fun",
        fallback: "أجعل الصلاة سهلة و طيبة")
    /// اللهم اجمعنا بهم جميعا في فردوسك الأعلي
    /// 🤲
    public static let mayWeReuniteAgainWithThemInTheHighestParadiseAlongAllOfThoseWhoPreceededUs🤲 = L10n.tr(
        "Localizables",
    ...
    public static func nOutOfN(_ p1: Any, _ p2: Any) -> String {
        L10n.tr("Localizables", "n out of n", String(describing: p1), String(describing: p2), fallback: "%@ من %@")
    }

    /// النوافل
    public static let nafila = L10n.tr("Localizables", "Nafila", fallback: "النوافل")
    /// الأسماء لا يوجد فيها ايموجيز.
    public static let namesCantContainEmojis = L10n.tr(
        "Localizables",
        "names_cant_contain_emojis",
        fallback: "الأسماء لا يوجد فيها ايموجيز.")
    /// الأسماء لا يوجد فيها أرقام
    public static let namesCantContainNumbers = L10n.tr(
        "Localizables",
        "names_cant_contain_numbers",
        fallback: "الأسماء لا يوجد فيها أرقام")
    /// الأسماء لا يوجد فيها حروف غريبة.
    public static let namesCantContainSpecialCharacters = L10n.tr(
        "Localizables",
        "names_cant_contain_special_characters",
        fallback: "الأسماء لا يوجد فيها حروف غريبة.")
    /// التالي
    ...
    /// الآن اصبحت التوبة اسهل, كذلك حلول المشاكل
    public static let nowRepentenceIsEasierAndSoAreSolutionsToProblems = L10n.tr(
        "Localizables",
        "Now Repentence is easier, and so are Solutions to problems!",
        fallback: "الآن اصبحت التوبة اسهل, كذلك حلول المشاكل")
    /// اوه, اهلا وسهلا! لقد وجدت صحيفة الخطط
    public static let ohHeyYouMadeItToThePlansPage = L10n.tr(
        "Localizables",
        "Oh hey!, you made it to the plans page!",
        fallback: "اوه, اهلا وسهلا! لقد وجدت صحيفة الخطط")
    ...
    public static let operationWhiteHeartIsTheFirstOperationOfAlNajdWhereYouDearBelieverWillEngageOnAJourneyOfEstigpharTheOperationMightBeDifficultButItEaseUpLotsOfFuturePlans =
        L10n.tr(
            ...
            fallback: "عملية القلب الأبيض هي أول عملية في النجد، حيث ستنخرط أنت، عزيزي المؤمن ، في رحلة استغفر. قد تكون العملية صعبة، لكنها تسهل الكثير من الخطط المستقبلية!")
    /// العملية: قلب أبيض
    ...
    public static let orBasicallySuggestAnActCombinedWithSomethingElse = L10n.tr(
        "Localizables",
        "Or basically suggest an act combined with something else",
        fallback: "أو تشير عليك بخلط عملين او اكثر مع ذكر فضلهم")
    /// غير انها سنة عن النبي, بل انها ايضا تساعدك في قيام الليل
    public static let otherThanBeingASunnahItContributeTowardsBeingQyamLayil = L10n.tr(
        "Localizables",
    ...
    public static func prayerTitle(_ p1: Any) -> String {
        L10n.tr("Localizables", "prayer_title", String(describing: p1), fallback: "صلاة %@")
    }
    ...
    public static let pretendToBeEverythingThatYouReNot = L10n.tr(
        "Localizables",
        "Pretend to be everything that you're not.",
        fallback: "تذاهر بكل ما انت لست اهل له")
    /// ضع مسافة بقدر ما تشاء بينك و بين الحقيقة
    public static let putAsMuchDistanceBetweenYouAndTheTruthAsYouWant = L10n.tr(
        "Localizables",
        "Put as much distance between you and the truth as you want",
        fallback: "ضع مسافة بقدر ما تشاء بينك و بين الحقيقة")
    ...
    public static let radytoBellah = L10n.tr(
        "Localizables",
        "RadytoBellah",
        fallback: "رضيت بالله ربا و بالإسلام دينا و بمحمد صلي الله عليه نبيا و رسولا")
    /// Plural format key: "%#@raqaatCount@"
    public static func raqaatCount(_ p1: Int) -> String {
        L10n.tr("Localizables", "raqaat_count", p1, fallback: "Plural format key: \"%#@raqaatCount@\"")
    }
    ...
    public static let rememberThatIslamIsTheOnlyWayToThereNow = L10n.tr(
        "Localizables",
        "Remember that Islam is the only way to there now.",
        fallback: "تذكر أن الإسلام هو السبيل الوحيد إلى هناك الآن.")
    /// تذكر لماذا أنت هنا في هذه
    public static let rememberWhyYouReHereInThis = L10n.tr(
        "Localizables",
        "Remember why you're here in this ",
        fallback: "تذكر لماذا أنت هنا في هذه ")
    /// تكرار متبقي
    ...
    /// اغني اهل الأرض لصلاتك لسنة الفچر
    public static let richestManOfAllWhoDidnTPray = L10n.tr(
        "Localizables",
        "Richest Man of all who didn't pray!",
        fallback: "اغني اهل الأرض لصلاتك لسنة الفچر")
    /// قم من ظلمات انهزامك ، الي نور رحمة الله و اختار
    public static let riseFromYourStrugglesAndPick = L10n.tr(
        "Localizables",
        "Rise from your struggles, and pick ",
        fallback: "قم من ظلمات انهزامك ، الي نور رحمة الله و اختار ")
    /// الطريق
    ...
    ///
    public static let sincePrayerIsTheColumnOfDeenWeMadeItEasyForYouToKeep = L10n.tr(
        "Localizables",
    ...
    /// ليس فقط النوم المريح ما اكتسبت بالعشاء, بالنصف قيام الليل الأول, وما ادراك ما نصف قيام الليل
    public static let sleepAndTranquility = L10n.tr(
        "Localizables",
    ...
    public static let soundsHapticFeedback = L10n.tr(
        "Localizables",
        "Sounds & Haptic Feedback",
        fallback: "اصوات & ردود الفعل اللمسية")
    /// الإلتزام بها لن يساعدك فقط في الوصول إلى وجهتك
    public static let stayingTrueToItWillNotOnlyHelpYouReachYourDestination = L10n.tr(
        "Localizables",
        "Staying true to it will not only help you reach your destination",
        fallback: "الإلتزام بها لن يساعدك فقط في الوصول إلى وجهتك")
    /// صعب الأمر؟ لا تقلق, الشخص المناسب, انه الفچر!, لكي تسهل عليك العبادة, فقط استيقظ له, فيسهل الباقي!
    public static let strugglingYouGotThisDoYouWantToKnowWhoCanHelpAlFajrMakeSureToPrayItSoOtherDeedsBecomeEasier = L10n.tr(
        "Localizables",
        "Struggling? you got this, do you want to know who can help? Al Fajr!, make sure to pray it so other deeds become easier!",
        fallback: "صعب الأمر؟ لا تقلق, الشخص المناسب, انه الفچر!, لكي تسهل عليك العبادة, فقط استيقظ له, فيسهل الباقي!")
    /// سبحان الله
    ...
    public static func sunnahTitle(_ p1: Any, _ p2: Any) -> String {
        L10n.tr("Localizables", "sunnah_title", String(describing: p1), String(describing: p2), fallback: "سنة %@ %@")
    }
    ...
    /// صلاة الآوابين, نعم العباد, الله يمدح و يعتز بعباده الآوابين, فما اكرمها من عبادة ان يمدح الله اهلها و ياله من شرف عظيم, بل يجعل لك ايضا الله في كل عمل لك صدقة, و يجعل علي كل سلامة (عظمة في جسدك) صدقة!
    public static let theAwabeenPrayerAllahPraiseThoseWhoAreAwabeenAndYouGetSadaqatOnAnyDeedYouDo = L10n.tr(
        "Localizables",
    ...
    public static let theDashboardIsAlsoAbleToGiveInsights = L10n.tr(
        "Localizables",
        "The Dashboard is also able to give insights",
        fallback: "هي أيضا قادرة على إعطاءك بعض النصائح")
    /// ذاك الفرض اللذي كان صعبا
    public static let theFaardThatWasTooHard = L10n.tr(
        "Localizables",
        "The Faard that was too hard",
        fallback: "ذاك الفرض اللذي كان صعبا ")
    /// شرف المؤمن, و اختص الله هذه الصلاة في الثلث الأخير من انه يتنزل الي السماء الدنيا فينادي علي عباده,هل من سائل فيعطى سؤله، هل من داع فيستجاب له، هل من مستغفر فيغفر له هل من تائب، فيتاب عليه؟, بل من معزة مصليها عند ربهم, يشع نور من بيته كل ليلة, حتي اذا غاب سئلت عنه الملائكة و دعت له اذا علمت بمرضه بالشفاء و استغفرت له
    ...
    /// كان صلي الله عليه و سلم لا يترك ركعتان ما بعد المغرب لفضلهم
    public static let theProphetSAWNeverLeftTheSunnahOfAlMaghrib = L10n.tr(
        "Localizables",
        "The Prophet SAW never left the Sunnah of Al Maghrib",
        fallback: "كان صلي الله عليه و سلم لا يترك ركعتان ما بعد المغرب لفضلهم")
    /// إن الطريق أمامنا طويل ولا يرحم.
    public static let theRoadAheadIsLongAndUnforgiving = L10n.tr(
        "Localizables",
        "The Road ahead is long, and unforgiving.",
        fallback: "إن الطريق أمامنا طويل ولا يرحم.")
    /// هنالك اكثر من ٢٥ فضل في صلاة الظهر, افضلها انها تقربك من الله
    public static let thereAre25BenefitInDuhrTheBestGettingCloserToAllah = L10n.tr(
        "Localizables",
        "There are 25+ benefit in Duhr, the best? Getting closer to Allah!",
        fallback: "هنالك اكثر من ٢٥ فضل في صلاة الظهر, افضلها انها تقربك من الله")
    /// لا يوجد مكان لك تهرب اليه, أيها المسلم
    public static let thereIsNoWhereYouCanHideMuslim = L10n.tr(
        "Localizables",
        "There is no where you can hide, Muslim",
        fallback: "لا يوجد مكان لك تهرب اليه, أيها المسلم")
    /// لا يتم ذلك على أي خادم، البيانات والإجراءات الخاصة بك ستظل علي هاتفك ولا نية لنا في جمعها.
    public static let thisIsNotDoneOnAnyServerYourDataAndActionsArePersonalAndWeIntendToKeepItThatWay = L10n.tr(
        "Localizables",
        "This is not done on any server, your data and actions are personal, and we intend to keep it that way",
        fallback: "لا يتم ذلك على أي خادم، البيانات والإجراءات الخاصة بك ستظل علي هاتفك ولا نية لنا في جمعها.")
    /// هذا العمل هو صدقة جارية ل...
    public static let thisWorkIsASadaqaFor = L10n.tr(
        "Localizables",
        "This work is a Sadaqa for...",
        fallback: "هذا العمل هو صدقة جارية ل...")
    ...
    public static func timesCount(_ p1: Int) -> String {
        L10n.tr("Localizables", "times_count", p1, fallback: "Plural format key: \"%#@timesCount@\"")
    }
    ...
    /// إلي أعلي الچنة!
    public static let toTheHighestRanksInJannah = L10n.tr(
        "Localizables",
        "To the highest ranks in Jannah",
        fallback: "إلي أعلي الچنة!")
    /// اليوم
    ...
    public static let trackOfItByJustSwipingFromTheSide = L10n.tr(
        "Localizables",
        "Track of it by just swiping from the side",
        fallback: "تتبع ذلك عن طريق سحبها من الجانب")
    /// حاول أن تتذكر نفسك، نفسك الجميلة، اللتي على قيد الحياة، لا المنهكة.
    public static let tryToRememberYourSelfYourBeautifulSelfTheAliveOneNotTheCurrent = L10n.tr(
        "Localizables",
        "Try to remember your self, your beautiful self, the alive one, not the current.",
        fallback: "حاول أن تتذكر نفسك، نفسك الجميلة، اللتي على قيد الحياة، لا المنهكة.")
    /// للأسف, لا يوجد ما يكفي من البيانات لتحليل هذا الأسبوع
    public static let unfortunatelyThereIsNotEnoughDataToAnalyzeThisWeek = L10n.tr(
        "Localizables",
        "Unfortunately there is not enough data to analyze this week",
        fallback: "للأسف, لا يوجد ما يكفي من البيانات لتحليل هذا الأسبوع")
    /// إستيقظ أيها المسلم.
    ...
    public static let weCurrentlyHaveOnly1PlanForEstigpharButMoreIsComingIsA = L10n.tr(
        "Localizables",
        "We currently have only 1 plan for Estigphar, but more is Coming isA",
        fallback: "حاليا يوجد خطة واحدة فقط و هي الأستغفار, ولكن المزيد قادم إن شاء الله, فترقب!")
    /// نأمل أن نتمكن من مساعدتك، حتى لو كان ذلك عن طريق شيء صغير جدا
    public static let weHopeWeMayBeAbleToHelpYouEvenIfBySomethingSoLittle = L10n.tr(
        "Localizables",
        "We hope we may be able to help you, even if by something so little",
        fallback: "نأمل أن نتمكن من مساعدتك، حتى لو كان ذلك عن طريق شيء صغير جدا")
    /// لذلك بذلنا جهدا للعثور على فوائد معظم الأفعال هنا
    public static let weTookAnEffortToFindWhatAreTheBenefitsOfMostOfTheDeedsHere = L10n.tr(
        "Localizables",
        "We took an effort to find what are the benefits of most of the deeds here",
        fallback: "لذلك بذلنا جهدا للعثور على فوائد معظم الأفعال هنا")
    /// هنئا لك, اصبح مالك, و دعاءك, و امنياتك مباركة, و ان شاء الله يفيض الله عليك ببركات, هذا ما كسبت من صلاة المغرب
    public static let wealthBuffedDuaAndWishesBuffedBlessingShoweredThatSWhatYouVeWonWithAlMaghrib = L10n.tr(
        "Localizables",
    ...
    public static func wellDone(_ p1: Any) -> String {
        L10n.tr(
            ...
            "Well Done",
            String(describing: p1),
            fallback: "ما شاء الله! الله عليك! اتممت صلاوات %@ كلها, ما شاء الله!")
    }
    ...
    public static func wellDoneOnPrayingAlFajrOnDay(_ p1: Any) -> String {
        L10n.tr(
            "Localizables",
            "Well done on praying Al Fajr on day",
            String(describing: p1),
            fallback: "أبليت حسنا علي صلاتك للفجر في %@")
    }

    /// بارك الله فيك 👏
    /// إن كنت صليتم في جماعة, فكأنما قمت الليل كله
    public static let wellDoneOnPrayingFajrAndAishaa👏IfYouPrayedThisInGroupTheRewardIsLikeYouVeDoneQeyamAlLayilOfTheWholeNight =
        L10n.tr(
            "Localizables",
            ...
            fallback: "بارك الله فيك 👏\nإن كنت صليتم في جماعة, فكأنما قمت الليل كله")
    /// ما شاء الله! الله عليك! اتممت الأذكار كلها, ما شاء الله!
    public static let wellDoneYouManagedToDoAllTheZekr = L10n.tr(
        "Localizables",
        "Well Done You Managed to do All the Zekr!",
        fallback: "ما شاء الله! الله عليك! اتممت الأذكار كلها, ما شاء الله!")
    /// رقعة وتر
    ...
    public static let wetrWhenDoneWith7VersesIsSameAsDoingQyamAlLayl = L10n.tr(
        "Localizables",
    ...
    public static let whereYouWillFindHowDidYouDoDuringATimePeriodNowItsStaticTo7Days = L10n.tr(
        "Localizables",
        "Where you will find how did you do during a time period (now its static to 7 days)",
        fallback: "حيث ستجد كيف فعلت خلال فترة زمنية (هي ثابتة عند 7 أيام حتي نحسنها)")
    /// يا ليت كان هناك ما يكفي لملئ هذا الأسبوع بالأعمال الرائعة, سنفعلها هذا الأسبوع
    public static let wouldnTItBeAwesomeIfWeHadAWeekSWorthOfAwesomeDeedsToDisplayHereLetSNailItThisWeek = L10n.tr(
        "Localizables",
        "Wouldn't it be awesome if we had a week's worth of awesome deeds to display here? let's nail it this week!",
        fallback: "يا ليت كان هناك ما يكفي لملئ هذا الأسبوع بالأعمال الرائعة, سنفعلها هذا الأسبوع")
    /// يمكنك سحب النتيجة من الأعلى
    public static let youCanDragTheCalendarFromAbove = L10n.tr(
        "Localizables",
        "You can drag the Calendar from above",
        fallback: "يمكنك سحب النتيجة من الأعلى")
    /// لا يمكنك التغير
    ...
    public static let youDonTRememberWhyYouReHereDoYou = L10n.tr(
        "Localizables",
        "You don't remember why you're here, do you?",
        fallback: "أنت لا تتذكر لماذا أنت هنا، أليس كذلك؟")
    /// ستظل دائما...
    ...
    public static let youReBetterThanThisThanNotRememberingWhyYouReHere = L10n.tr(
        "Localizables",
        "You're better than this, than not remembering why you're here.",
        fallback: "أنت أفضل من هذا، من عدم تذكر سبب وجودك هنا.")
    /// رفيقك الي چنة الأخري
    public static let yourCompanionToABetterAkhra = L10n.tr(
        "Localizables",
        "Your companion to a better Akhra",
        fallback: "رفيقك الي چنة الأخري")
    /// اصبحت الأن اقرب من الله
    public static let yourImanGrowFurther = L10n.tr(
        "Localizables",
        "Your Iman Grow further!",
        fallback: "اصبحت الأن اقرب من الله")
    /// نچدك
